...
public class DataManager2 
{
    ...
    private void load() 
    {
            ...
            while (sc.hasNextLine()) 
        {
                ...
                {
                    Teacher teacher = new Teacher(new User(splitter[0],splitter[1], splitter[2], splitter[3].equals("t")));
                ...
                {
                    Student student = new Student(new User(splitter[0],splitter[1], splitter[2], splitter[3].equals("t")));
                    arr.add(student);
                }
